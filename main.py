...
async def root_route_handler(request):
    return web.json_response("https://txt-to-vid-5z8r.onrender.com") ## change it with your host url
...
async def start(client: Client, msg: Message):
    ...
    await start_message.edit_text(
        Data.START.format(msg.from_user.mention) +
        "Checking status Ok... Command Nhi Bataunga **Bot Made BY 𝐆𝐚𝐮𝐫𝐚𝐯👨🏻‍💻**🔍\n\n"
        "Progress:[🟩🟩🟩🟩🟩🟩🟩🟩🟩] 100%\n\n"
    )
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:  
                ...
                cc = f'**╭━━━━━━━━━━━╮\n💫 𝐕ɪᴅᴇᴏ 𝐈𝐃: {str(count).zfill(3)}\n╰━━━━━━━━━━━╯\n\n📝 𝐓ɪᴛʟᴇ: {name1} \n├─𝐄xᴛᴇɴꜱɪᴏɴ: [{my_name}](https://t.me/call_me_kund).mkv\n├─𝐑ᴇꜱᴏʟᴜᴛɪᴏɴ: {res}\n\n📚 𝐂ᴏᴜʀꜱᴇ: {b_name}\n\n📥 𝐃ᴏᴡɴʟᴏᴀᴅᴇᴅ 𝐁ʏ: {CR}\n\n**━━━━━✦🚩जय श्री राम🚩✦━━━━━**'
                cc1 = f'**╭━━━━━━━━━━━╮\n💫 𝐏ᴅꜰ 𝐈𝐃: {str(count).zfill(3)}\n╰━━━━━━━━━━━╯\n\n📝 Title: {name1} \n├─𝐄xᴛᴇɴꜱɪᴏɴ: [{my_name}](https://t.me/call_me_kund).pdf\n\n📚 𝐂ᴏᴜʀꜱᴇ: {b_name}\n\n📥 𝐃ᴏᴡɴʟᴏᴀᴅᴇᴅ 𝐁ʏ : {CR}\n\n**━━━━━✦🚩जय श्री राम🚩✦━━━━━**'
                cyt = f'**╭━━━━━━━━━━━╮\n💫 𝐕ɪᴅᴇᴏ 𝐈𝐃: {str(count).zfill(3)}\n╰━━━━━━━━━━━╯\n\n📝 𝐓ɪᴛʟᴇ: {name1} \n├─𝐄xᴛᴇɴꜱɪᴏɴ: [{my_name}](https://t.me/call_me_kund).mkv\n├─𝐑ᴇꜱᴏʟᴜᴛɪᴏɴ: {res}\n\n📚 𝐂ᴏᴜʀꜱᴇ: {b_name}\n\n📥 𝐃ᴏᴡɴʟᴏᴀᴅᴇᴅ 𝐁ʏ: {CR}\n\n**━━━━━✦🚩जय श्री राम🚩✦━━━━━**'
                ccp = f'**╭━━━━━━━━━━━╮\n💫 𝐕ɪᴅᴇᴏ 𝐈𝐃: {str(count).zfill(3)}\n╰━━━━━━━━━━━╯\n\n📝 𝐓ɪᴛʟᴇ: {name1} \n├─𝐄xᴛᴇɴꜱɪᴏɴ: [{my_name}](https://t.me/call_me_kund).mkv\n├─𝐑ᴇꜱᴏʟᴜᴛɪᴏɴ: {res}\n\n📚 𝐂ᴏᴜʀꜱᴇ: {b_name}\n\n📥 𝐃ᴏᴡɴʟᴏᴀᴅᴇᴅ 𝐁ʏ: {CR}\n\n**━━━━━✦🚩जय श्री राम🚩✦━━━━━**'
                czip = f'**╭━━━━━━━━━━━╮\n💫 𝐕ɪᴅᴇᴏ 𝐈𝐃: {str(count).zfill(3)}\n╰━━━━━━━━━━━╯\n\n📝 𝐓ɪᴛʟᴇ: {name1} \n├─𝐄xᴛᴇɴꜱɪᴏɴ: [{my_name}](https://t.me/call_me_kund).mkv\n├─𝐑ᴇꜱᴏʟᴜᴛɪᴏɴ: {res}\n\n📚 𝐂ᴏᴜʀꜱᴇ: {b_name}\n\n📥 𝐃ᴏᴡɴʟᴏᴀᴅᴇᴅ 𝐁ʏ: {CR}\n\n**━━━━━✦🚩जय श्री राम🚩✦━━━━━**'
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:  
                ...
                cc1 = f'📁 𝐏𝐃𝐅_𝐈𝐃: **{str(count).zfill(3)}**\n\n> 📝 𝐓𝐈𝐓𝐋𝐄:👇🏻\n> [{name1} .pdf](https://t.me/call_me_kund)\n\n📚 𝐁𝐀𝐓𝐂𝐇 𝐍𝐀𝐌𝐄:👇🏻\n{b_name}\n\n✨𝐄𝐗𝐓𝐑𝐀𝐂𝐓𝐄𝐃 𝐁𝐘 : {CR}\n\n━━━━━✦𝐆𝐚𝐮𝐫𝐚𝐯❤️✦━━━━━'
    ...
    try:
        ...
        # Check if the response status is OK
            ...
            # Remove the PDF file after sending
                    ...
                    Show = f"📥 𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐢𝐧𝐠 »\n\n📝 𝐓𝐢𝐭𝐥𝐞:- `{name}\n\n**🔗 𝐓𝐨𝐭𝐚𝐥 𝐔𝐑𝐋 »** ✨{str(count).zfill(3)}/{len(links)}✨\n\n⌨ 𝐐𝐮𝐚𝐥𝐢𝐭𝐲 » {raw_text2}`\n\n**🔗 𝐔𝐑𝐋 »** `Nahi Dikhaunga, kya kar loge 😂`\n\n**𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦𝐆𝒂ꪊ𝘳𝒂ꪜ❤️"
                    prog = await m.reply_text(Show)
                    res_file = await helper.download_video(url, cmd, name)
                    filename = res_file
                    await prog.delete(True)
    ...
    try:
        ...
        # Check if the response status is OK
            ...
            # Remove the PDF file after sending
                    ...
                    Show = f"📥 𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐢𝐧𝐠 »\n\n📝 𝐓𝐢𝐭𝐥𝐞:- `{name}\n\n**🔗 𝐓𝐨𝐭𝐚𝐥 𝐔𝐑𝐋 »** ✨{str(count).zfill(3)}/{len(links)}✨\n\n⌨ 𝐐𝐚𝐮𝐥𝐢𝐭𝐲 » {raw_text2}`\n\n**🔗 𝐔𝐑𝐋 »** `Maalik ne batane se mana kiya hai re😂`\n\n**𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ 𝐆𝒂ꪊ𝘳𝒂ꪜ❤️"
                    prog = await m.reply_text(Show)
                    res_file = await helper.download_video(url, cmd, name)
                    filename = res_file
                    await prog.delete(True)
